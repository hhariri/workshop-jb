...
class EffectiveDate<R> : ReadWriteProperty<R, MyDate> {
    ...
    operator override fun get(thisRef: R, property: PropertyMetadata): MyDate = timeInMillis!!.toDate()
    operator override fun set(thisRef: R, property: PropertyMetadata, value: MyDate) { timeInMillis = value.toMillis() }
}
